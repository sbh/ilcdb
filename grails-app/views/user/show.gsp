<html>
    <head>
        ...
        <title><g:message code="default.show.label" args="[entityName]" default="User" /></title>
    </head>
    <body>
        <div class="body">
            <h1><g:message code="default.show.label" args="[entityName]" default="User" /></h1>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: userInstance, field: "roleDisplayName")}</td>
                        </tr>
